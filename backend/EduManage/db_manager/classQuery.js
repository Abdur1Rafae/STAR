const QUERY = 
{
    ...
    GET_CLASSES : 'Select ClassID, ClassName, JSON_ARRAYAGG(JSON_OBJECT("SectionID", SectionID, "SectionName", SectionName)) AS Sections from Class JOIN Section using(ClassID) where TeacherID = ? GROUP BY ClassName, ClassID;',
