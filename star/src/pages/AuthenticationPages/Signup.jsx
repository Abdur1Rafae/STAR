        ...
        <div className='flex-auto border border-black p-4 rounded-lg max-md:mt-8'>
          <div className='flex flex-col items-center'>
            <div className="w-max bg-white border-2 text-xs border-black rounded-full flex overflow-hidden">
              <button
                type="button"
                className={`px-4 py-2 flex items-center tracking-wider font-semibold outline-none transition-all duration-300 ${isTeacherMode ? 'bg-DarkBlue text-white' : 'bg-gray-50 text-black'}`}
              ...
              <button
                type="button"
                className={`px-4 py-2 flex items-center tracking-wider font-semibold outline-none transition-all duration-300 ${isTeacherMode ? 'bg-gray-50 text-black' : 'bg-DarkBlue text-white'}`}
          ...
          <form className='py-4 text-sm flex-grow min-w-72'>
