...
import { GetFlagDetails, PenalizeResponse } from '../../APIS/Teacher/GradingAPI'
          ...
          </div>
          {
            ...
            <div className="fixed mx-auto my-auto bg-opacity-50 inset-0 flex items-center justify-center w-full h-full bg-black">
              <div className="bg-white rounded-xl shadow-md p-6 md:max-w-80">
                  <h3 className='text-xl font-medium'>Penalising Student</h3>
                  <div className="text-sm mb-4 mt-4">Based on the proof provided, you can penalise the student by deducting a percentage of marks from their final score. This deduction will be applied when assessment's grades are published.</div>
                ...
                <p className='text-xs ml-2 mt-2'><strong>Once grades have been published, you cannot undo the penalty.</strong></p>
                  <div className="flex justify-center gap-4 mt-4">
                      <SubmitButton label={"Cancel"} onClick={()=>setPenaliseBox(false)}/>
                      <SubmitButton label={"Confirm"} active={true} onClick={handlePenalty} />
                  </div>
              </div>
            </div>
          }
