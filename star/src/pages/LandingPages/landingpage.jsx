...
<div className='w-full scroll-smooth '>
    ...
    <div className='md:sticky top-0 md:h-screen w-full bg-DarkBlue md:content-center max-md:py-8 max-md:px-4'>
    ...
    <div className='md:sticky top-0  bg-[#F4F9FD] md:h-screen md:grid grid-cols-2 content-center px-12  items-center gap-2'>
    <div className='max-md:hidden '>
        <img src={cover4} alt=""  className=''/>
        </div> 
       
        <div className='w-full md:h-screen mt-12 '>
