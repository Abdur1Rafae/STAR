...
const CourseCard = ({Quiz_Count, Course_Title}) => {
  return (
    <button className='text-left w-56 h-[90px] bg-[#F4F9FD] mt-4 rounded-md border-[1px] border-black transition-all duration-200 flex flex-col justify-between hover:scale-105'>
