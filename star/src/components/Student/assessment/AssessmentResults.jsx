...
const AssessmentResults = ({percent,correct, skipped, incorrect }) => {
  return (
    <div className='flex-grow bg-LightBlue h-28 md:mb-0 flex p-2 items-center justify-around drop-shadow-md md:w-60 w-full'>
        <div className='h-28 flex'>
            <CircularProgressBar percentage={percent} width={8}/>
        </div>
        <div className='w-1/2 flex flex-col'>
            <div className='flex justify-between border-b-[1px] border-black'>
                ...
                <div className='ml-8 flex items-center mb-2'>
                    ...
                    <h5 className='text-xs font-medium ml-4'>{correct}</h5>
                </div>
            </div>
            <div className='flex justify-between border-b-[1px] border-black mt-2'>
                ...
                <div className='ml-6 flex items-center mb-2'>
                    ...
                    <h5 className='text-xs font-medium ml-4'>{incorrect}</h5>
                </div>
            </div>
            <div className='flex justify-between mt-2'>
                ...
                <div className='ml-7 flex items-center'>
                    ...
                    <h5 className='text-xs font-medium ml-4'>{skipped}</h5>
                </div>
            </div>
        </div>
    </div>
