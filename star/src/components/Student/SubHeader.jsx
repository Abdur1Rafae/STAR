        ...
        <navbar className="h-12 bg-LightBlue border-b-[1px] border-black font-body">
            <div className="h-full flex w-full justify-around md:justify-start md:w-auto text-[#2C6491]">
                ...
                <div className="h-full flex">
                    <button className={`flex items-center justify-center w-full ${isActive === 'Courses' ? 'text-DarkBlue border-b-2 border-DarkBlue' : 'text-gray-500 group relative inline-block'}`} onClick={()=>{window.location.assign("/student/courses")}}>
