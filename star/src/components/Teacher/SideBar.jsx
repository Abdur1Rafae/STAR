...
const SideBar = ({active}) => {
  ...
  return (
    <div className={`overflow-hidden order-[2] md:order-first md:sticky md:top-0 md:min-w-[60px] md:max-w-[60px] md:h-screen md:border-r-[1px] bg-LightBlue w-full transition-height ease-out duration-500 ${showNav ? 'h-28' : 'h-0'} border-b-[1px] border-black flex items-center justify-center font-body`}>
