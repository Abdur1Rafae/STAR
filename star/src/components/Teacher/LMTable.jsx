  ...
  return (
    ...
    <thead className=''>
        <tr className='text-center text-md font-semibold text-gray-600'>
            <th className='px-1 py-3 tracking-wide  border-[#937D7D]'>Name
            </th>
            <th className='px-1 py-3 tracking-wide  border-[#937D7D] flex justify-center items-center'>Section  
            ...
            <th className='px-1 py-3 tracking-wide border-[#937D7D]'>Start Time</th>
            <th className='px-1 py-3 tracking-wide  border-[#937D7D]'>Submit Time</th>
            <th className='px-1 py-3 tracking-wide  border-[#937D7D] flex justify-center item-center'>Status
    ...
    <tbody className="">
        {
            data.map((row) => (
                <tr className='w-full text-center drop-shadow-md bg-LightBlue'>
