        ...
        <div className="h-12 bg-LightBlue border-b-[1px] border-black font-body">
            <div className="h-full flex w-full justify-around md:justify-start md:w-auto text-[#2C6491]">
                <div className="h-full flex md:ml-4 md:mr-8">
                    <button className={`flex items-center w-full ${isActive === 'Dashboard' ? 'text-DarkBlue border-b-2 border-DarkBlue' : 'text-black group relative inline-block'} justify-center`} onClick={()=>{window.location.assign("/home")}}>
                ...
                <div className="h-full flex">
                    <button className={`flex items-center justify-center w-full ${isActive === 'Courses' ? 'text-DarkBlue border-b-2 border-DarkBlue' : 'text-black group relative inline-block'}`} onClick={()=>{window.location.assign("/courses")}}>
