...
const CourseCard = ({Quiz_Count, Course_Title}) => {
  return (
    <div className='card-container w-56 h-[90px] bg-[#E7ECEF] mt-4 rounded-md'>
        <div className='pl-2 pt-2 pr-2 text-sm'>{Course_Title}</div>
        <div className='h-[25px] bg-[#274C77] text-white relative -bottom-4 flex flex col items-center rounded-b-lg'>
            {
